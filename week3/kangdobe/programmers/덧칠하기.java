...
public class 덧칠하기 {
    public int solution(int n, int m, int[] section) {
        ...
        for (int i = 0; i < section.length; i++) {
            ...
            // 현재 start부터 m만큼 칠했다고 가정 > 마지막 칠해진 지점 갱신
...
/*
 ...
 벽에 동아리 · 학회 홍보나 회사 채용 공고 포스터 등을 게시하기 위해 테이프로 붙였다가 철거할 때 떼는 일이 많고 그 과정에서
  페인트가 벗겨지곤 합니다. 페인트가 벗겨진 벽이 보기 흉해져 학교는 벽에 페인트를 덧칠하기로 했습니다.
